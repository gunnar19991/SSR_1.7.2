...
public class CreateShard 
{
    ...
    private boolean isFormedVertically(World world, int x, int y, int z)
    {
        ...
        Block blocks3[] = {world.getBlock(x, y + 1, z), world.getBlock(x, y - 1, z), world.getBlock(x + 1, y, z), world.getBlock(x + 1, y, z)};
        Block blocks4[] = {world.getBlock(x - 1, y + 1, z), world.getBlock(x - 1, y - 1, z), world.getBlock(x + 1, y + 1, z), world.getBlock(x + 1, y - 1, z),
                         world.getBlock(x, y + 2, z), world.getBlock(x, y - 2, z), world.getBlock(x + 2, y, z), world.getBlock(x - 2, y, z)};
